          ...
          <div class="card card-primary">
              ...
              <!-- /.card-header -->
                ...
                <div class="card-body">
                  ...
                  <input readonly type="text" value="${boardTypeVO.board_type}" class="form_control" name="board_type" id="board_type" required>
					  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                  	...
                  	<input type="text" value="${boardTypeVO.board_sun}" class="form-control" name="board_sun" id="board_sun" placeholder="게시판순서를 입력해 주세요" required>
                  </div>
