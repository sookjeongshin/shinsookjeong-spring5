...
public class SampleController {
	 ...
	 * HomeController.java 를 저장하면, 이클립스에서는 HomeController.class 실행가능한 파일을 생성 그래서,
	 * 저장시 콘솔에 보시면, Reloading Context with... is completed 재실행 되었다고 나옵니다. 그래서, .java
	 * 클래스는 수정 후 약간 기다린 후 Reloading... 메시지 후 결과 확인이 가능합니다.
	 */
